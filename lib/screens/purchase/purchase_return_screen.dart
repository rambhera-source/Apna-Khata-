    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          ...
          children: [
            const Text('Purchase Return Preview', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.blue)),
            IconButton(
                ...
                const Center(
                  child: Column(
                    children: [
                      ...
                      Text('Purchase Return / Debit Note', style: TextStyle(fontSize: 11, color: Colors.grey)),
                    ],
                  ),
                ),
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: _showPurchaseReturnPreviewDialog,
                      ),
                    ),
                  ),
                  const SizedBox(width: 4),
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.blue.shade900, foregroundColor: Colors.white, padding: EdgeInsets.zero, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4))),
