  ...
  Future<bool> _onWillPop() async {
    ...
    final shouldPop = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Kya aap waqai is purchase return bill ko exit karna chahte hain? Aapke add kiye gaye items hat jayenge.', style: TextStyle(fontSize: 13)),
        actions: [
          TextButton(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Add Return Product:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blue)),
