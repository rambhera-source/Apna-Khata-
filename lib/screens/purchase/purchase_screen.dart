...
class _PurchaseScreenState extends State<PurchaseScreen> {
  ...
  Future<void> _savePurchaseTransaction() async {
    ...
    // ✨ Purchase Saved Success Dialog with Share & Print options
    showDialog(
      context: context,
                                  ...
                                  itemBuilder: (context, index) {
                                    if (index == options.length) {
                                      return ListTile(
                                        ...
                                        title: Text('Add New: "${_partyController.text}"', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: Colors.blue)),
                          ...
                          if (_selectedInlineProduct != null) ...[
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(backgroundColor: Colors.blue.shade800, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8)),
