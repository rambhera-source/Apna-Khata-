                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 6),
                                      Text('₹${total.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.green)),
                                      IconButton(
                          ...
                          if (_selectedInlineProduct != null) ...[
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(backgroundColor: Colors.green.shade800, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8)),
